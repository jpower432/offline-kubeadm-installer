...
# Pull yum packages
RUN apt-get install -y --download-only  docker-ce=5:19.03.8~3-0~ubuntu-bionic containerd.io=1.2.13-1 docker-ce-cli=5:19.03.8~3-0~ubuntu-bionic kubeadm kubectl kubelet
