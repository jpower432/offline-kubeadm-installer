...
# Pull crictl
RUN curl -L https://github.com/kubernetes-sigs/cri-tools/releases/download/1.19.0/crictl-1.19.0-linux-arm.tar.gz --output payload/dependencies/crictl-1.19.0-linux-arm.tar.gz
